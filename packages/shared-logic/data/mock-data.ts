...
export const mockPublicPagesContent: PublicPagesContent = {
    ...
    privacy: {
        ...
        sections: [
            ...
            { title: "المعلومات التي نجمعها", content: [
                { list: [
                    "**معلومات التعريف الشخصية:** قد نطلب منك تزويدنا بمعلومات تعريف شخصية معينة يمكن استخدامها للاتصال بك أو التعرف عليك. تشمل هذه المعلومات، على سبيل المثال لا الحصر، الاسم وعنوان البريد الإلكتروني.",
                    "**بيانات الاستخدام:** نقوم بجمع معلومات حول كيفية الوصول إلى الخدمة واستخدامها (\"بيانات الاستخدام\"). قد تتضمن بيانات الاستخدام هذه معلومات مثل عنوان بروتوكول الإنترنت الخاص بجهاز الكمبيوتر الخاص بك (مثل عنوان IP)، ونوع المتصفح، وإصدار المتصفح، وصفحات خدمتنا التي تزورها، ووقت وتاريخ زيارتك، والوقت الذي تقضيه على تلك الصفحات."
                ] }
            ]},
            { title: "استخدام البيانات", content: ["نستخدم البيانات التي نجمعها لأغراض مختلفة:", { list: ["لتوفير وصيانة خدمتنا.", "لإعلامك بالتغييرات التي تطرأ على خدمتنا.", "للسماح لك بالمشاركة في الميزات التفاعلية لخدمتنا عندما تختار القيام بذلك.", "لتقديم خدمة العملاء والدعم.", "لتحليل المعلومات القيمة حتى نتمكن من تحسين خدمتنا.", "لمراقبة استخدام الخدمة.", "للكشف عن المشكلات الفنية ومنعها ومعالجتها."] }] },
            { title: "أمن البيانات", content: ["أمن بياناتك مهم بالنسبة لنا، ولكن تذكر أنه لا توجد وسيلة نقل عبر الإنترنت أو طريقة تخزين إلكتروني آمنة 100٪. بينما نسعى جاهدين لاستخدام وسائل مقبولة تجاريًا لحماية معلوماتك الشخصية، لا يمكننا ضمان أمنها المطلق."] },
            { title: "حقوقك", content: ["لديك الحق في الوصول إلى معلوماتك الشخصية التي نحتفظ بها وتحديثها أو حذفها. إذا كنت ترغب في ممارسة هذا الحق، يرجى الاتصال بنا."] },
            { title: "خصوصية الأطفال", content: ["خدمتنا لا تخاطب أي شخص دون سن 18 عامًا (\"الأطفال\"). نحن لا نجمع عن قصد معلومات تعريف شخصية من أي شخص دون سن 18 عامًا. إذا كنت والدًا أو وصيًا وتدرك أن أطفالك قد زودونا بمعلومات شخصية، فيرجى الاتصال بنا."] },
            { title: "روابط لمواقع أخرى", content: ["قد تحتوي خدمتنا على روابط لمواقع أخرى لا يتم تشغيلها من قبلنا. إذا قمت بالنقر فوق ارتباط جهة خارجية، فسيتم توجيهك إلى موقع تلك الجهة الخارجية. ننصحك بشدة بمراجعة سياسة الخصوصية لكل موقع تزوره."] },
            { title: "التغييرات على سياسة الخصوصية هذه", content: ["قد نقوم بتحديث سياسة الخصوصية الخاصة بنا من وقت لآخر. سنقوم بإعلامك بأي تغييرات عن طريق نشر سياسة الخصوصية الجديدة على هذه الصفحة."] },
            { title: "اتصل بنا", content: ["إذا كان لديك أي أسئلة حول سياسة الخصوصية هذه، يرجى الاتصال بنا عبر البريد الإلكتروني: [سيتم إضافة البريد الإلكتروني قريباً]."] }
        ]
    },
    terms: {
        ...
        sections: [
            ...
            { title: "الملكية الفكرية", content: ["الخدمة ومحتواها الأصلي وميزاتها ووظائفها هي وستظل ملكية حصرية لـ \"هليو آب\" ومرخصيها. الخدمة محمية بموجب حقوق النشر والعلامات التجارية والقوانين الأخرى في كل من مصر والبلدان الأجنبية."] },
            { title: "حسابات المستخدمين", content: ["عند إنشاء حساب معنا، يجب عليك تزويدنا بمعلومات دقيقة وكاملة وحديثة في جميع الأوقات. يشكل عدم القيام بذلك خرقًا للشروط، مما قد يؤدي إلى الإنهاء الفوري لحسابك على خدمتنا."] },
            { title: "السلوك المحظور", content: ["أنت توافق على عدم استخدام الخدمة لأي غرض غير قانوني أو محظور بموجب هذه الشروط. لا يجوز لك استخدام الخدمة بأي طريقة يمكن أن تلحق الضرر بالخدمة أو تعطلها أو تفرط في تحميلها أو تضعفها."] },
            { title: "إنهاء الحساب", content: ["يجوز لنا إنهاء أو تعليق حسابك على الفور، دون إشعار مسبق أو مسؤولية، لأي سبب من الأسباب، بما في ذلك على سبيل المثال لا الحصر إذا خرقت الشروط."] },
            { title: "القانون الحاكم", content: ["تخضع هذه الشروط وتفسر وفقًا لقوانين جمهورية مصر العربية، بغض النظر عن تعارضها مع أحكام القانون."] },
            { title: "اتصل بنا", content: ["إذا كان لديك أي أسئلة حول هذه الشروط، يرجى الاتصال بنا."] }
        ]
    },
