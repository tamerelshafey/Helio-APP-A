                    ...
                    <aside className="hidden md:block md:col-span-1">
                        <nav className="sticky top-24">
                            ...
                            <ul className="space-y-2 border-r-2 border-slate-200 dark:border-slate-700 pr-4">
                                {content.sections.map((section, index) => (
                                    <li key={index}>
                                        <a href={`#terms-section-${index}`} className="block text-sm text-gray-500 dark:text-gray-400 hover:text-cyan-500 hover:border-cyan-500 dark:hover:border-cyan-400 py-1 transition-colors">
                                            {section.title}
                                        </a>
                                    </li>
                                ))}
